...
namespace Content.Client.UserInterface.Systems.Ghost.Controls.Roles
{
    ...
    public sealed partial class GhostRolesWindow : DefaultWindow
    {
        ...
        public void AddEntry(string name, string description, string rules, bool hasAccess, FormattedMessage? reason, IEnumerable<GhostRoleInfo> roles, SpriteSystem spriteSystem)
        {
            ...
            var info = new GhostRoleInfoBox(name, description, rules);
